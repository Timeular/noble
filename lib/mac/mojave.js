 ...
 * @discussion tested
 */
nobleBindings.on('kCBMsgId51', function(args) {
 ...
 * @discussion tested
 */
nobleBindings.on('kCBMsgId67', function(args) {
  var deviceUuid = args.kCBMsgArgDeviceUUID.toString('hex');
 ...
 * @discussion tested
 */
nobleBindings.on('kCBMsgId53', function(args) {
  var deviceUuid = args.kCBMsgArgDeviceUUID.toString('hex');
 ...
 * @discussion tested
 */
nobleBindings.on('kCBMsgId81', function(args) {
  var deviceUuid = args.kCBMsgArgDeviceUUID.toString('hex');
 ...
 * @discussion tested
 */
nobleBindings.on('kCBMsgId82', function(args) {
  var deviceUuid = args.kCBMsgArgDeviceUUID.toString('hex');
  var serviceUuids = [];
  ...
  if (args.kCBMsgArgServices) {
    for(var i = 0; i < args.kCBMsgArgServices.length; i++) {
      ...
      if (!this._peripherals[deviceUuid].services[service.uuid] ) {
        ...
        var oldService = this._peripherals[deviceUuid].services[service.uuid];
 ...
 * @discussion tested
 */
nobleBindings.on('kCBMsgId88', function(args) {
  var deviceUuid = args.kCBMsgArgDeviceUUID.toString('hex');
 ...
 * @discussion tested
 */
nobleBindings.on('kCBMsgId89', function(args) {
  var deviceUuid = args.kCBMsgArgDeviceUUID.toString('hex');
  var serviceStartHandle = args.kCBMsgArgServiceStartHandle;
  var serviceUuid = this._peripherals[deviceUuid].services[serviceStartHandle].uuid;
  var result = args.kCBMsgArgResult;
 ...
 * @discussion tested
 */
nobleBindings.on('kCBMsgId95', function(args) {
  var deviceUuid = args.kCBMsgArgDeviceUUID.toString('hex');
  ...
  if (peripheral) {
    ...
    console.warn('noble (mojave): received read event from unknown peripheral: ' + deviceUuid + ' !');
  }
});
 ...
 * @discussion tested
 */
nobleBindings.on('kCBMsgId96', function(args) {
  var deviceUuid = args.kCBMsgArgDeviceUUID.toString('hex');
  var characteristicHandle = args.kCBMsgArgCharacteristicHandle;
  var result = args.kCBMsgArgResult;
 ...
 * @discussion tested
 */
nobleBindings.on('kCBMsgId98', function(args) {
  var deviceUuid = args.kCBMsgArgDeviceUUID.toString('hex');
  var characteristicHandle = args.kCBMsgArgCharacteristicHandle;
  var result = args.kCBMsgArgResult;
 ...
 * @discussion tested
 */
nobleBindings.on('kCBMsgId99', function(args) {
  var deviceUuid = args.kCBMsgArgDeviceUUID.toString('hex');
  var characteristicHandle = args.kCBMsgArgCharacteristicHandle;
  var result = args.kCBMsgArgResult;
 ...
 * @discussion tested
 */
nobleBindings.on('kCBMsgId102', function(args) {
  var deviceUuid = args.kCBMsgArgDeviceUUID.toString('hex');
 ...
 * @discussion tested
 */
nobleBindings.on('kCBMsgId103', function(args) {
  var deviceUuid = args.kCBMsgArgDeviceUUID.toString('hex');
  var descriptorHandle = args.kCBMsgArgDescriptorHandle;
  var result = args.kCBMsgArgResult;
